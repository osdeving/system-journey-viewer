...
- Latest dock host overflow hotfix (2026-06-27) disables tab overflow navigation for single-tab dock hosts and enforces a shared `320px` minimum width for single-tab managed dock windows, including restored/persisted side hosts and small floating managed windows.
