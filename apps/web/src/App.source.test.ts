...
describe('App source regressions', () => {
  ...
  it('persists and wires a node depth-effects preference into the canvas renderer', () => {
    expect(appSource).toContain('nodeDepthEffectsEnabled: false')
  ...
  it('wires command palette, minimap, and performance mode into the app shell', () => {
    ...
    expect(appSource).toContain('statusBarEnabled: true')
    ...
    expect(appSource).toContain('parsed.statusBarEnabled ?? DEFAULT_UI_PREFERENCES.statusBarEnabled')
